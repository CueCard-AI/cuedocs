...
from drf_helper.mixins import CreatedByModelMixin
from drf_helper.models import BaseModel
from django.utils.translation import gettext_lazy as _
from safedelete.models import HARD_DELETE, SOFT_DELETE_CASCADE, SOFT_DELETE
...
class User(DirtyFieldsMixin, AbstractUser, BaseModel, CreatedByModelMixin):
    """User model."""
    ...
    password = models.CharField(max_length=128, blank=True, null=True) # No password is required for JWKS Auth
